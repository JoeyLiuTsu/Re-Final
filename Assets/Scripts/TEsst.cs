...
public class enemySpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        { // Choose a random location within the spawnRadius 
            ...
            //NavMeshHit hit;
            //if (NavMesh.SamplePosition(randomLoc3d, out hit, 100, 1)) { randomLoc3d = hit.position; }
            //// Instantiate and make the enemy a child of this object 
            //GameObject o = (GameObject)Instantiate(enemyPrefab, randomLoc3d, transform.rotation); o.GetComponent<enemyMovement>().player = player;
        }
